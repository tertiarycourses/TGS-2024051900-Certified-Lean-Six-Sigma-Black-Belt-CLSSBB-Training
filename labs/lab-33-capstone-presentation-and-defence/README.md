# Lab 33 — Capstone Presentation and Defence

**DMAIC phase:** CAPSTONE  |  **Lab type:** Core  |  **Course:** Certified Lean Six Sigma Black Belt (CLSSBB) Training (TGS-2024051900)

## Objective

Present and defend your capstone project to a simulated steering committee (A1-A5, K1, K2).
...
A delivered 15-minute presentation with a defended Q&A session.

**Tools and techniques:** Presentation delivery, handling challenge, methodological defence, peer assessment, professional judgement
