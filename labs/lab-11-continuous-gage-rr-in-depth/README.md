...
Validate a continuous measurement system for your capstone using Gage R&R (A4).
...
A completed crossed Gage R&R study with %study variation and ndc for your capstone metric.

**Tools and techniques:** Accuracy, bias, linearity, stability, repeatability, reproducibility, %study variation, ndc, %tolerance
